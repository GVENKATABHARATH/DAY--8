...
# this is a special method which has the ablity to execute is itself without
# calling it manullay through th eprocess of instantiation
# throught this process
class profile:
    def___ init__(self):# constructor method
        print("hey")
